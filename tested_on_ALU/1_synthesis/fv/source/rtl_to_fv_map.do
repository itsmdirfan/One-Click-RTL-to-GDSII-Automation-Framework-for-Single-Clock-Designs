...
# Generated on: Fri Dec 12 15:59:45 IST 2025 (Fri Dec 12 10:29:45 UTC 2025)
...
set logfile fv/source/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/source -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/home/vlsi12/c2s/cadence/install/GENUS211/tools.lnx86"
set CDN_SYNTH_ROOT      "/home/vlsi12/c2s/cadence/install/GENUS211/tools.lnx86"
set env(CW_DIR) "/home/vlsi12/c2s/cadence/install/GENUS211/tools.lnx86/lib/chipware"
set CW_DIR      "/home/vlsi12/c2s/cadence/install/GENUS211/tools.lnx86/lib/chipware"
...
add_search_path /home/vlsi12/Downloads/scl_pdk/stdlib/fs120/liberty/lib_flow_ss -library -both
...
add_search_path ../home/vlsi12/Desktop/irfan/test/1_synthesis -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  source.v
elaborate_design -golden -root {source} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/source/fv_map.v.gz
elaborate_design -revised -root {source}
...
#add_name_alias fv/source/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.source.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.source.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.source.rtl.fv_map.rpt
