...
# Generated on: Thu May 21 13:04:21 IST 2026 (Thu May 21 07:34:21 UTC 2026)
...
set logfile fv/alu_top/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/alu_top -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/home/vlsi3/c2s/cadence/install/GENUS211/tools.lnx86"
set CDN_SYNTH_ROOT      "/home/vlsi3/c2s/cadence/install/GENUS211/tools.lnx86"
set env(CW_DIR) "/home/vlsi3/c2s/cadence/install/GENUS211/tools.lnx86/lib/chipware"
set CW_DIR      "/home/vlsi3/c2s/cadence/install/GENUS211/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /home/vlsi3/c2s/cadence/install/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/home/vlsi3/c2s/cadence/install/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/home/vlsi3/c2s/cadence/install/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/home/vlsi3/c2s/cadence/install/GENUS211/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/home/vlsi3/c2s/cadence/install/GENUS211/tools.lnx86/lib/chipware/sim"
}
...
add_search_path /home/vlsi3/Downloads/scl_pdk/stdlib/fs120/liberty/lib_flow_ss -library -both
read_library -liberty -both \
    /home/vlsi3/Downloads/scl_pdk/stdlib/fs120/liberty/lib_flow_ss/tsl18fs120_scl_ss.lib
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  alu_top.v adder.v logic_unit.v
elaborate_design -golden -root {alu_top} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/alu_top/fv_map.v.gz
elaborate_design -revised -root {alu_top}
...
#add_name_alias fv/alu_top/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.alu_top.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.alu_top.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.alu_top.rtl.fv_map.rpt
